function VerifyUser() {
    ...
    const [verificationCode, setVerificationCode] = React.useState(defaultVerificationCode || '');
    ...
    return (
        <div id="item-container">
            ...
            />
            <button onClick={handleVerification} id="verify-button">Verify</button>
            {countdown !== null ? <div>Account has been verified. Redirecting to the Login page in {countdown} seconds...</div> : null}
        </div>
    );
}

const root = ReactDOM.createRoot(document.getElementById('root'));
root.render(<VerifyUser />);
